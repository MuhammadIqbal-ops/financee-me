  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={data}>
        ...
        />
        <Legend />
        <Line type="monotone" dataKey="Pemasukan" stroke="hsl(var(--income))" strokeWidth={2} dot={false} />
        <Line type="monotone" dataKey="Pengeluaran" stroke="hsl(var(--expense))" strokeWidth={2} dot={false} />
